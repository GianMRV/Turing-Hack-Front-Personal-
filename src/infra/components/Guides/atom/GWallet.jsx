...
const URL = 'https://www.business2community.com/es/wp-content/uploads/sites/5/2022/04/Mejores-Bitcoin-wallets-en-2022-monederos-de-BTC-comparados-hoy.jpeg'
    ...
    return(
        <>
            <Flex direction={'column'}>
                <Image src={URL} ></Image>
                <Heading>Configura tu Wallet</Heading>
                <Text pt={5}>
